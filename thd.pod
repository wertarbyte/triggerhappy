...
B<thd> [B<--help>] [B<--dump>] [B<--socket> I<socket>] [B<--trigger> I<config>] [B<--daemon>] [B<--pidfile> I<file>] [I<devices...>]
...
B<thd --triggers /etc/triggerhappy/triggers.conf --socket /var/run/triggerhappy.socket>
