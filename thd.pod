...
Normalize REL events. If this option is enabled, the values of relative movement events are mapped to the three values -1, 0 and 1, depending on the sign of the value reported by the kernel.
